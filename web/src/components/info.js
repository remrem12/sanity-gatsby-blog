...
const Info = () => {
    return (
        <div className='container info'>
            {/* EDU & SKILL */}
            <div className='row edu-skill info-block'>
                <div className='col-xs-12 col-md-6 edu'>
                    <h2 className='info-title'><i class="fas fa-graduation-cap"></i> Học vấn</h2>
                    <ul className='edu-list'>
                        <li>Trường ĐH Khoa Học Tự Nhiên</li>
                        <li>Chuyên Ngành Khoa học máy tính</li>
                    </ul>
                </div>
                <div className='col-xs-12 col-md-6 skill'>
                    <h2 className='info-title'><i class="fas fa-laptop-code"></i> Kĩ năng</h2>
            ...
            {/* PROJECTS */}
            <div className='row projects info-block'>
                <h2 className='info-title'>Pet Projects</h2>
            </div>

            {/* CONTACT */}
            <div className='row contact info-block'>
