...
export default class AboutMe extends React.Component {
  ...
  render () {
    return (
      <>
        <button className='about-button btn' onClick={this.handleClick}>
          <i class="fas fa-info fa-2x"></i>
        </button>
        <div className={`card ${this.state.showInfo ? '' : 'minimize'}`} data-state='#about'>
          <div className='card-header'>
            ...
            <img
              ...
              alt='avatar'
            />
            <h1 className='card-fullname'>Bùi Hữu Nghĩa</h1>
            ...
            <div className='card-section is-active' id='about'>
              <div className='card-content'>
                ...
                <p className='card-desc'>
                  Whatever tattooed stumptown art party sriracha gentrify hashtag intelligentsia
                  readymade schlitz brooklyn disrupt.
                </p>
              </div>
              <div className='card-social'>
                <a href='https://www.facebook.com/hakunonn/' target='_blank'>
                  <svg viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                    <path d='M15.997 3.985h2.191V.169C17.81.117 16.51 0 14.996 0c-3.159 0-5.323 1.987-5.323 5.639V9H6.187v4.266h3.486V24h4.274V13.267h3.345l.531-4.266h-3.877V6.062c.001-1.233.333-2.077 2.051-2.077z' />
                  </svg>
                </a>
                <a href='https://twitter.com/__hei12' target='_blank'>
                ...
                <a href='https://www.instagram.com/hakunonn/' target='_blank'>
                ...
                <a href='https://www.linkedin.com/in/buihuunghia/' target='_blank'>
                  <svg viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
