      ...
      <MDBNavbar color="default-color" fixed="top" transparent light expand="md" className="header">
        ...
        <MDBCollapse id="navbarCollapse3" isOpen={this.state.isOpen} navbar>
          ...
          <MDBNavbarNav left className="menu">
            ...
            <MDBNavItem>
              <Link className="nav-link waves-effect" to="/blogs">
                Blogs
              </Link>
            </MDBNavItem>
          </MDBNavbarNav>
          ...
          <MDBNavbarNav right className="social">
            <li className="nav-item">
              <a
                href="https://www.facebook.com/hakunonn"
            ...
            <li className="nav-item">
              <a
                href="mailto:buihuunghia.10hlvc@gmail.com"
                rel="noopener noreferrer"
                className="nav-link  waves-effect"
                target="_blank"
              >
            ...
            <li className="nav-item">
              <a
                href="https://twitter.com/__hei12"
                rel="noopener noreferrer"
                className="nav-link  waves-effect"
                target="_blank"
              >
            ...
            <li className="nav-item">
              <a
                href="https://www.linkedin.com/in/ngh%C4%A9a-b%C3%B9i-h%E1%BB%AFu-b86004191/"
                rel="noopener noreferrer"
                className="nav-link waves-effect"
                target="_blank"
              >
